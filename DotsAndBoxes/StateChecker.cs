...
namespace DotsAndBoxes;
    ...
    {
        protected readonly Brush BlackBrushCode = Brushes.Black;
        protected readonly Brush WhiteBrushCode = Brushes.White;
        ...
        protected bool BrushCompare(Brush brushAsString1, Brush brushAsString2)
        {
        ...
        {
            if (BrushCompare(line.Color, BlackBrushCode) ||
                BrushCompare(line.Color, WhiteBrushCode))
                return false;
            return true;
        }
